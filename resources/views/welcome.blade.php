...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        .text-container h1 {
            font-size: 42px; /* Ukuran font untuk h1 */
            margin-bottom: 10px; /* Jarak antara h1 dan h2 */
            margin-top: 10px; /* Jarak antara h1 dan h2 */
        }

        .text-container h2 {
            font-size: 24px; /* Ukuran font untuk h2 */
            margin-top: 10px; /* Jarak antara h2 dan h1 */
        }
            </style>
        ...
        body {
            position: relative; /* Diperlukan untuk mengatur posisi absolut dari lapisan ::before */
            font-family: 'Poppins';
        ...
        body::before {
            content: ""; /* Menambahkan lapisan ::before */
            position: absolute; /* Memastikan lapisan ::before dapat ditempatkan secara bebas */
            top: 0;
            left: 0;
            width: 100%;
            height: 100%;
            background-image: linear-gradient(to right, rgba(0,0,0,1), rgba(0,0,0,0)), url('LandingPage.jpg');
            background-repeat: no-repeat;
            background-size: cover;
            filter: brightness(100%); /* Kecerahan gambar latar belakang */
